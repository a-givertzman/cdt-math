                ...
                CtxResult::Ok(ctx) => {
                    ...
                    let result = match initial.load_comb {
                        LoadingCombination::A1 | LoadingCombination::B1 => match initial.driver_type {
                            LiftingMechanismDriveType::Hd1 => initial.vhmax_lift_hoist,
                            LiftingMechanismDriveType::Hd2 | LiftingMechanismDriveType::Hd3 => initial.vhcs_lift_hoist,
                            LiftingMechanismDriveType::Hd4 => Self::vhmax_half(initial.vhmax_lift_hoist),
                            LiftingMechanismDriveType::Hd5 => 0.0,
                        },
                        LoadingCombination::C1 => match initial.driver_type {
                            LiftingMechanismDriveType::Hd1 | LiftingMechanismDriveType::Hd2 | LiftingMechanismDriveType::Hd4 => initial.vhmax_lift_hoist,
                            LiftingMechanismDriveType::Hd3 | LiftingMechanismDriveType::Hd5 => Self::vhmax_half(initial.vhmax_lift_hoist),
                        },
                    };

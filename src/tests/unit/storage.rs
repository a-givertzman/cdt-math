...
mod user_select {
    ...
    fn test_get_fmg() {
        ...
        let test_data =[
            (("конструкции/крюки/тип крюка/крюк однорогий/ИСО/1/грузоподъемность/M1/"), 0.4),
            (("конструкции/крюки/тип крюка/крюк однорогий/ИСО/2/грузоподъемность/M1/"), 0.5),
            (("конструкции/крюки/тип крюка/крюк однорогий/ИСО/3/грузоподъемность/M1/"), 0.63),
            (("конструкции/крюки/тип крюка/крюк однорогий/ИСО/4/грузоподъемность/M1/"), 0.8),
        ];
